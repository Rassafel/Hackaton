...
users = {
    389049692:
             {
                 'anchor': 'wait_add_product_loop',
                 'addresses':
                     [
                         {'name': 'Никитинская ул., 108, Самара, Самарская обл., Россия, 443041',
                          'latitude': 53.196046,
                          'longitude': 50.1225263,
                          'distance': 10.0
                          }
                     ],
                 'products': ['яблоко']
...
def run_parsing():
    ...
    with open(r'C:\Users\user\Desktop\vk.txt',
              'r') as f:
    ...
    with open(r'group_id.txt', 'r') as f:
        for line in f:
...
if __name__ == '__main__':
    with open(r'C:\Users\user\Desktop\bot_Token.txt', 'r') as f:
        TOKEN = f.readline()
    GROUP_ID = 196299691
